...
urlpatterns = patterns('',
                       ...
                       url(r'^center/(?P<code>\S+)$', 'userpage.views.uc_center'),
                       url(r'^ticket/(?P<weixinid>\S+)$', 'userpage.views.uc_ticket'),
                       url(r'^account/(?P<weixinid>\S+)$', 'userpage.views.uc_account'),
                       url(r'^couple/(?P<weixinid>\S+)$', 'userpage.views.uc_2ticket'),
                       url(r'^token/(?P<weixinid>\S+)$', 'userpage.views.uc_token'),
