...
urlpatterns = patterns('',
                       ...
                       url(r'^detail/(?P<act_id>\d+)/$', 'adminpage.views.activity_detail'),
                       url(r'^checkin/(?P<act_id>\d+)/$', 'adminpage.views.activity_check_in'),
                       url(r'^checkin/(?P<act_id>\d+)/check/', 'adminpage.views.activity_check_in_post'),
                       url(r'^export/(?P<act_id>\d+)/$', 'adminpage.views.activity_export_stunum'),
