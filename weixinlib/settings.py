        ...
        },
		{
            ...
            "sub_button": [
                ...
                },
                {
                    "type": "view",
                    "name": "个人中心",
                    "url": "https://open.weixin.qq.com/connect/oauth2/authorize?appid="+WEIXIN_APPID+"&redirect_uri="+"http://wx2.igeek.asia/u/center"+"&response_type=code&scope=snsapi_base#wechat_redirect"
                },
                #{
                #    "type": "click",
                #    "name": "查票",
